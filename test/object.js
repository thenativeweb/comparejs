...
suite('object x object', function () {
  ...
  suite('eq', function () {
    ...
    suite('not equal => false', function () {
      ...
      test('object x falsy', function () {
        cmp.eq(o1, r1).should.equal(false);
      });

      test('falsy x object', function () {
  ...
  suite('ge', function () {
    ...
    suite('not equal => false', function () {
      ...
      test('null x falsy'       , function () {
        cmp.ge(null, r1).should.equal(false);
      });

      test('falsy x null'       , function () {
