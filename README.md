...
- Supports comparison of objects using deep-equal.
- Supports comparison of objects with `<`, `<=`, `>` and `>=` by handling them as subsets.
...
- Developed using TDD and backed up by more than 570 unit tests.
